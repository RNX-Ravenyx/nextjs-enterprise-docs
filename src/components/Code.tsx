  ...
  return (
    <button
      ...
      className={clsx(
        ...
        copied
          ? 'bg-purple-700/10 ring-1 ring-inset ring-purple-700/20'
    ...
    >
      ...
      <span
        aria-hidden={!copied}
        className={clsx(
          'pointer-events-none absolute inset-0 flex items-center justify-center text-purple-700 transition duration-300',
          !copied && 'translate-y-1.5 opacity-0',
        )}
      >
        Copied!
